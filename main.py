...
if st.button("2.Channels have the most number of videos, and how many videos do they have"):
     ...
     data = {
          "channel name" : [db_return[0]],
          "total videos" : [db_return[1]]
     }
